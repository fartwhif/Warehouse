...
namespace Warehouse
{
    public partial class PluginCore
    {
        ...
        private void CharacterFilter_ChangePlayer(object sender, ChangePlayerEventArgs e)
        {
            // DO STUFF HERE
        }
        ...
        private void CharacterFilter_ChangeSettings(object sender, SettingsEventArgs e)
        {
            // DO STUFF HERE
        }
        private void CharacterFilter_ChangeShortcut(object sender, ChangeShortcutEventArgs e)
        {
            // DO STUFF HERE
        }
        ...
        {
            TimeSinceLoginStarted = Stopwatch.StartNew();
            loggedIn = true;
        }
        private void CharacterFilter_LoginComplete(object sender, EventArgs e)
        {
            //DO NOT USE THIS, Bug in ACE causes this never to fire if character is stuck in hangman mode upon login, villa basement, etc. (known bug in ACEmulator)
        }
